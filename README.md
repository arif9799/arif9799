...
I am an experienced Data Scientist with a strong foundation in Python development and machine learning, holding a Master’s in Data Science from Northeastern University. My professional journey spans diverse roles, from developing deep learning and machine learning models to creating predictive analytics solutions. I excel in deploying scalable AI solutions, with hands-on expertise in Python, PyTorch, and various ML frameworks. At Puma North America, I built demand forecasting systems and anomaly detection apps, significantly improving operational efficiency. Passionate about Fintech, I aim to leverage my skills in statistical analysis, time series forecasting, and data-driven decision-making to drive innovation and enhance financial services. I am eager to collaborate on projects that intersect technology and finance, making data-driven insights accessible and actionable.
